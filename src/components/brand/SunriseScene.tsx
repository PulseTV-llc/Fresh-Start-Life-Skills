...
export function SunriseScene({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-[linear-gradient(178deg,#9fd9de_0%,#bce7e8_22%,#dcf1ef_44%,#f6f2e2_64%,#ffeccb_84%,#ffe2b4_100%)]" />
        {/* Warm bloom around the sun, painted onto the sky itself */}
        <div className="absolute inset-0 bg-[radial-gradient(60%_46%_at_69%_74%,rgba(245,179,54,0.68)_0%,rgba(250,206,134,0.34)_38%,rgba(255,255,255,0)_72%)]" />
      </motion.div>
      ...
      >
        <motion.div style={{ y: still(sunDriftY, 0) }} className="relative">
          ...
          <div className="absolute left-1/2 top-1/2 size-[46vh] max-h-[520px] max-w-[520px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(245,179,54,0.44)_0%,rgba(250,206,134,0.16)_46%,rgba(255,255,255,0)_70%)] animate-sun-pulse" />
          <div
            className="absolute left-1/2 top-1/2 size-[30vh] max-h-[340px] max-w-[340px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(242,166,41,0.52)_0%,rgba(255,255,255,0)_68%)] animate-sun-pulse"
            style={{ animationDelay: "-3.5s" }}
          />
          {/* Disc */}
          <div className="relative size-[16vh] max-h-[178px] min-h-[96px] min-w-[96px] max-w-[178px] rounded-full bg-[radial-gradient(circle_at_38%_32%,#fff8e6_0%,#ffdc93_30%,#f5b336_64%,#dd8f12_100%)] shadow-[0_0_70px_18px_rgba(242,166,41,0.55)]" />
        </motion.div>
      </motion.div>
      ...
      >
        <defs>
          <linearGradient id="fsl-far" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#bfdfd2" />
            <stop offset="100%" stopColor="#95c9b6" />
          </linearGradient>
        </defs>
      ...
      <motion.svg
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
        className="absolute inset-x-0 bottom-0 h-[13%] w-full"
